...
import { KubePersistentVolumeClaim, KubeDeployment, ContainerPort, EnvVar, ResourceRequirements, Volume, KubeService, Quantity } from 'cdk8s-plus-25/lib/imports/k8s';
