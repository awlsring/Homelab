...
class ImportedServiceAccount extends Construct implements IServiceAccount {
  ...
  constructor(
    ...
    id: string,
    name: string,
    options: FromServiceAccountNameOptions = {},
  ) {
    super(scope, id);
    this._name = name;
...
export class ServiceAccount
  ...
  implements IServiceAccount, rb.ISubject
{
  /**
   ...
   */
  public static fromServiceAccountName(
    scope: Construct,
    id: string,
    name: string,
    options: FromServiceAccountNameOptions = {},
  ...
  constructor(scope: Construct, id: string, props: ServiceAccountProps = {}) {
    ...
    this.apiObject = new k8s.KubeServiceAccount(this, "Resource", {
      ...
      secrets: Lazy.any({
        produce: () =>
          undefinedIfEmpty(this._secrets.map((s) => ({ name: s.name }))),
      }),
